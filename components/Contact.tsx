    ...
    <section id="contact" className="section-white apple-section scroll-mt-16">
      <div className="container-wide">
        ...
        <div className="grid gap-8 lg:grid-cols-[1.4fr,0.6fr]">
          <div data-cta="form" />
          <aside className="space-y-4"><div className="rounded-3xl bg-[#1d1d1f] p-7 text-white"><h3 className="text-xl font-semibold text-white mb-3">อยากคุยโดยตรง?</h3><p className="text-sm text-gray-300">ส่ง model list และ current stack มาก่อนได้</p></div><a data-cta="email" className={channelClass}><Mail className="text-[#06c]" size={19} /></a><a data-cta="tel" className={channelClass}><Phone className="text-[#06c]" size={19} /></a><a data-cta="line" className={channelClass}><MessageCircle className="text-[#06c]" size={19} />LINE Official</a></aside>
        </div>
      </div>
    </section>
  );
